...
int e[MAXEAMTZ][8], a[MAXEAMTZ][8], m[MAXEAMTZ][8], t[MAXEAMTZ][8], 
z[MAXEAMTZ][8];
...
/* + second: S = Set E/A/M permanent or R = Reset E/A/M permanent */
    ...
    if (strcmp(s_operation[i],"R" ) == 0)
    {
      ...
      {
        if (b_vkl == 1) t[i_baustein[i]][i_bitnr[i]] = 0;
      }
      if (strcmp(s_operand[i],"Z" ) == 0)
      {
        if (b_vkl == 1) z[i_baustein[i]][i_bitnr[i]] = 0;
      }
      if (strcmp(s_operand[i],"E" ) == 0)
      {
        if (b_vkl == 1) e[i_baustein[i]][i_bitnr[i]] = 0;
      }
      if (strcmp(s_operand[i],"A" ) == 0)
      {
        if (b_vkl == 1) a[i_baustein[i]][i_bitnr[i]] = 0;
      }
      if (strcmp(s_operand[i],"M" ) == 0)
      {
        if (b_vkl == 1) m[i_baustein[i]][i_bitnr[i]] = 0;
      }
      b_vkb = 1; /* allow b_vkl to be set to 1! */
    }
    ...
    if (strcmp(s_operation[i],"S" ) == 0)
    {
      if (strcmp(s_operand[i],"T" ) == 0)
      {
        if (b_vkl == 1) t[i_baustein[i]][i_bitnr[i]] = accu;
      }
      if (strcmp(s_operand[i],"Z" ) == 0)
      {
        if (b_vkl == 1) z[i_baustein[i]][i_bitnr[i]] = accu;
      }
      if (strcmp(s_operand[i],"E" ) == 0)
      {
        if (b_vkl == 1) e[i_baustein[i]][i_bitnr[i]] = 1;
      }
      if (strcmp(s_operand[i],"A" ) == 0)
      {
        if (b_vkl == 1) a[i_baustein[i]][i_bitnr[i]] = 1;
      }
      if (strcmp(s_operand[i],"M" ) == 0)
      {
        if (b_vkl == 1) m[i_baustein[i]][i_bitnr[i]] = 1;
      }
      b_vkb= 1; /* allow b_vkl to be set to 1! */
    }
...
/* Z = count Z -> V = +1 if < MAXINT and R = -1 if > 0 */
   ...
   if (strcmp(s_operation[i],"Z" ) == 0)
   {
     ...
     {
      if (b_vkl == 1) if (z[i_baustein[i]][i_bitnr[i]] < MAXINT) z[i_baustein[i]][i_bitnr[i]]++;
     }
     if (strcmp(s_operand[i],"R" ) == 0)
     {
      if (b_vkl == 1) if (z[i_baustein[i]][i_bitnr[i]] > 0) z[i_baustein[i]][i_bitnr[i]]--;
     }
     b_vkb= 1; /* allow b_vkl to be set to 1! */
   }
